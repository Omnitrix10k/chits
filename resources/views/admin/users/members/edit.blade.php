    ...
    <div class="max-w-3xl rounded-lg bg-white p-6 shadow-sm">
        <form method="POST" action="{{ route('admin.members.update', $member) }}" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input id="referred_by_name" name="referred_by_name" type="text" value="{{ old('referred_by_name', $member->referred_by_name) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" placeholder="{{ __('Enter referrer name') }}">
