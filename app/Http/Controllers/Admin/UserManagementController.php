...
class UserManagementController extends Controller
{
    ...
    public function storeMember(Request $request): RedirectResponse
    {
        ...
        $member = User::query()->create([
            ...
            'family_name' => $this->normalizeNullableString($validated['surety_name'] ?? null),
            'family_relation' => $this->normalizeNullableString($validated['surety_relation'] ?? null),
            'family_phone_number' => $this->normalizeNullableString($validated['surety_phone_number'] ?? null),
            'family_address' => $this->normalizeNullableString($validated['surety_address'] ?? null),
            'family_government_id' => $this->normalizeNullableString($validated['surety_government_id'] ?? null),
            'family_bank_name' => $this->normalizeNullableString($validated['surety_bank_name'] ?? null),
            'family_cheque_number' => $this->normalizeNullableString($validated['surety_cheque_book_number'] ?? null),
    ...
    private function memberRules(?User $member = null): array
    {
        return [
            ...
            'surety_relation' => ['nullable', Rule::in(self::SURETY_RELATIONS)],
            'surety_phone_number' => ['nullable', 'string', 'regex:/^\+?[0-9]{7,15}$/'],
            'surety_address' => ['nullable', 'string', 'max:1000'],
            'surety_government_id' => ['nullable', 'string', 'max:255'],
            'surety_bank_name' => ['nullable', 'string', 'max:255'],
            'surety_cheque_book_number' => ['nullable', 'string', 'max:255'],
